...
use llvm_sys::target::{self, LLVMTargetDataRef, LLVMOpaqueTargetData};
...
impl Target {
    ...
    pub fn get_name(&self) -> &str {
        unsafe {
            util::to_str(target_machine::LLVMGetTargetName(self.into()) as
                *mut c_char)
        }
    }
    ...
    pub fn get_description(&self) -> &str {
        unsafe {
            util::to_str(target_machine::LLVMGetTargetDescription(self.into()) as
                *mut c_char)
        }
    }
